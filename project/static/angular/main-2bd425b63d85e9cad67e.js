...
let ApiService = class ApiService {
    ...
    getProduclList(pars) {
        if (pars.hasOwnProperty('cat')) {
            return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].backendUrl}v1/market/product_list?category=${pars.cat}`);
        }
        if (pars.hasOwnProperty('subcat')) {
            return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].backendUrl}v1/market/product_list?subcategory=${pars.subcat}`);
        }
        return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].backendUrl}v1/market/product_list`);
    }
    getCategoryList() {
        return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].backendUrl}v1/market/category_list`);
    }
    getBasketInfo(pars) {
        const data = { ids: pars };
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].backendUrl}v1/market/basket_list`, data);
    }
    loginByGoogle(data) {
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].backendUrl}v1/market/google_auth`, data);
    }
    init() {
        return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].backendUrl}v1/market/init`);
    }
    addProduct(data) {
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].backendUrl}v1/market/add_product`, data);
    }
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("#app-content {\n  height: 100%;\n  padding: 5px;\n}\n\n#app-header {\n  border-bottom: 1px solid #3F51B5;\n  color: #3F51B5;\n}\n\n#app-center {\n  padding-top: 10px;\n  padding-left: 10px;\n}\n\n#app-footer {\n  text-align: center;\n}\n\n#title-text {\n  font-size: 30px;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
let AppComponent = class AppComponent {
    ...
    signInWithGoogle() {
        ...
        this.authService.signIn(angularx_social_login__WEBPACK_IMPORTED_MODULE_4__["GoogleLoginProvider"].PROVIDER_ID).then(res => {
...
/*!*******************************!*\
  !*** ./src/app/app.module.ts ***!
  \*******************************/
/*! exports provided: interceptorProviders, provideConfig, AppModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _basket_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./basket.service */ "./src/app/basket.service.ts");
...
/* harmony import */ var _auth_interceptor_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./auth-interceptor.service */ "./src/app/auth-interceptor.service.ts");
...
const interceptorProviders = [
    { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HTTP_INTERCEPTORS"], useClass: _auth_interceptor_service__WEBPACK_IMPORTED_MODULE_16__["AuthInterceptorService"], multi: true }
];
const config = new angularx_social_login__WEBPACK_IMPORTED_MODULE_14__["AuthServiceConfig"]([
    {
        ...
        provider: new angularx_social_login__WEBPACK_IMPORTED_MODULE_14__["GoogleLoginProvider"]("80372353865-uibudu5b8is15fhtgcr45av97sm16n2u.apps.googleusercontent.com")
    }
]);
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        providers: [
            _basket_service__WEBPACK_IMPORTED_MODULE_12__["BasketService"],
            angularx_social_login__WEBPACK_IMPORTED_MODULE_14__["AuthService"],
            ...
            _auth_interceptor_service__WEBPACK_IMPORTED_MODULE_16__["AuthInterceptorService"],
...
module.exports = __webpack_require__(/*! C:\Users\offic\Desktop\NewDjangoShop\frontend\ng-prj\src\main.ts */"./src/main.ts");


/***/ })

},[[0,"runtime","vendor"]]]);
//# sourceMappingURL=main-2bd425b63d85e9cad67e.js.map